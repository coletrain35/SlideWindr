...
│   ├── slidewindr-icon.png      # Logo icon (favicon)
│   └── slidewindr-wordmark.png  # Logo wordmark
├── src/
...
SlideWindr works best in modern browsers with WebGL support:
- Chrome 90+
- Firefox 88+
- Safari 14+
- Edge 90+
